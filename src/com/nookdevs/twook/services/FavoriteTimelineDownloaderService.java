...
public class FavoriteTimelineDownloaderService extends MessagesDownloaderService {
    /*LOG COMMENT  private static final String TAG = FavoriteTimelineDownloaderService.class.getName();  LOG COMMENT*/
